...
TRACKING_PROFILE = TrackingProfile(
    name="tracking",
    kp=np.array([3150.0, 3850.0, 3150.0, 1260.0, 980.0, 700.0]),
    ki=np.zeros(6),
    kd=np.array([78.4, 89.6, 78.4, 39.2, 33.6, 28.0]),
    inverse_dynamics_kp=np.array([1800.0, 2200.0, 1800.0, 720.0, 560.0, 400.0]),
    inverse_dynamics_kd=np.array([28.0, 32.0, 28.0, 14.0, 12.0, 10.0]),
